			...
			<div class="col-md-8 main">
				...
				<div class="deal-wrapper">
					...
					<?php else: ?>
							...
							<div class="single-learn-premium"><button><a href="<?php echo site_url(); ?>/premium">Learn More About Premium</a></button></div>
				...
				<div class="deal-wrapper premium-cta col-md-12">
					...
					<a id="signup"></a>
						<h2 class="title"><?php the_field('premium_title', 'option'); ?></h2>
						<h3 class="subtitle"><?php the_field('premium_subtitle', 'option'); ?></h3>
