	...
	<div class="row">
				...
				<div class="email col-md-8 col-md-offset-2 text-center">
					...
					<form action="//cheapflightsfromtampa.us16.list-manage.com/subscribe/post?u=bc044b5ce916ab5cd6505c30d&amp;id=597366555e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					    ...
					    <div class="clear"><button><input type="submit" value="Send Me Cheap Flight Deals!" name="subscribe" id="mc-embedded-subscribe" class="button"></button></div>
					    </div>
					</form>
					</div>
...
<!-- Dup Start How It Works -->
<div class="container-fluid">

		<div class="row">

				<div class="how-wrapper col-md-10 col-md-offset-1">
...
<div class="container-fluid">
	...
	<div class="recent-deal-wrapper text-center col-md-12" style="background: linear-gradient(
			...
			<p class="recent-deal-title">Recent deal</p><!--/.recent-deal-title-->
			<svg class="underline underline-icon" viewBox="0 0 352 32">
		  	     <use xlink:href="#underline-icon" />
		  	</svg>
			
			<p class="recent-deal">Tampa -> <?php echo $first_row_destination ?>: $<?php echo $first_row_price ?></p><!--/.recent-deal-->
...
<div class="container-fluid">
	<div class="row">
			...
			<div class="intro-wrapper text-left col-md-10 col-md-offset-1">
				...
				<div class="col-md-5 col-md-offset-1">
					...
					<div class="intro-body col-md-5 text-left">
						...
						<form action="//cheapflightsfromtampa.us16.list-manage.com/subscribe/post?u=bc044b5ce916ab5cd6505c30d&amp;id=597366555e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" style="padding: 0" target="_blank" novalidate>
							...
							<input type="email" style="margin-left: 0px !important" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Enter your email address..." required>
						    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
						    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_bc044b5ce916ab5cd6505c30d_597366555e" tabindex="-1" value=""></div>
						    <div class="clear"><button style="padding-left: 0"><input type="submit" value="Send Me Cheap Flight Deals!" name="subscribe" id="mc-embedded-subscribe" class="button"></button></div>
						    </div>
						</form>
						</div>
						
						
						<!--<div class="button-input-secondary"><a href="https://cheapflightsfromtampa.com/about/" alt="About Cheap Flights From Tampa"><button class="button-secondary">About</button></a></div>
						<div class="button-input-secondary"><a href="https://cheapflightsfromtampa.com/faq/" alt="About Cheap Flights From Tampa"><button class="button-secondary">FAQs</button></a></div>-->
...
<div class="container-fluid">
		<div class="row">
			...
			<div class="recent-deal-wrapper text-center col-md-12" style="background: linear-gradient(
				...
				<div class="recent-deal">Tampa -> <?php echo $second_row_destination ?>: $<?php echo $second_row_price ?></div><!--/.recent-deal-->
...
<div class="container-fluid">
	<div class="row perfect-for-bg">
		<div class="perfect-for-wrapper text-center col-md-10 col-md-offset-1">
